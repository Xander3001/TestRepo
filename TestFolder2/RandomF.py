...
# #the spacy library bag of words is trained on the english language so I am using the en_core_sci_lg library trained specifically on scientific documents. 
# #This library also contains dictionary of common abbreivations and nomenclature for the scientific field
