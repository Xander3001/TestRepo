...
# punctuations = '!"#$%&\'()*+,-/:;<=>?@[\\]^_`{|}~'
# doc = nlp('Donncha O\'Callaghan is an ex international rugby player. He is a natural phenomenom who plays a giant role within his sport. His achievements in rugby have been tremendous.')
# 
# #['Donncha O\'Callaghan', 'international', 'phenomenom', 'role', 'sport', 'achievements', 'rugby']
# #[('O\'Callaghan', 'PERSON'), ('international', 'NORP'), ('rugby', 'NORP'), ('phenomenom', 'PERSON'), ('role', 'PERSON'), ('sport', 'NORP'), ('achievements', 'NORP'), ('rugby', 'NORP')]
# 
# #nouns = [ token.text for token in doc if token.is_stop != True and token.is_punct !=True and token.pos_ == 'NOUN']
