...
# while (cap.isOpened()):
# # Four initial weights for logistic regression were imported
#         ret, img = cap.read()
#         img, contours, thresh = get_img_contour_thresh(img)
# # Four initial weights for neural network were imported
# # b was not used in this code because b for two hidden layers is a 1 by 2 vector
#         ans1 = ''
#         ans2 = ''
#         ans3 = ''
#         if len(contours) > 0:
